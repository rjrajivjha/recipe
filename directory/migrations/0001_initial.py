# Generated by Django 3.2.18 on 2023-05-04 17:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('alternate', models.CharField(blank=True, default=None, max_length=128, null=True)),
                ...
                ('ingredient', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='directory.ingredient')),
                ('recipe', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='directory.recipe')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='recipe',
            name='ingredients',
            field=models.ManyToManyField(through='directory.RecipeIngredients', to='directory.Ingredient'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='meal_type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='directory.mealtypes'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='meat_type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='directory.meattypes'),
        ),
    ]
